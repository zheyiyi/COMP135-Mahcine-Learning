...
plt.ylim((0, 1.1))
plt.legend()
plt.title("Figure3 d = 3 and w = 10")
plt.ylabel("error ratio")
plt.xlabel("iteration number")
...
plt.ylim((0, 1.1))
plt.legend()
plt.title("Figure4 d = 3 and w = 15")
plt.ylabel("error ratio")
plt.xlabel("iteration number")
...
plt.ylim((0, 1.1))
plt.legend()
plt.title("Figure5 d = 3 and w = 20")
plt.ylabel("error ratio")
plt.xlabel("iteration number")
...
plt.ylim((0, 1.1))
plt.legend()
plt.title("Figure6 d = 3 and w = 30")
plt.ylabel("error ratio")
plt.xlabel("iteration number")
...
plt.ylim((0, 1.1))
plt.legend()
plt.title("Figure7 d = 3 and w = 40")
plt.ylabel("error ratio")
plt.xlabel("iteration number")
plt.savefig('graph7.png')


w_set = [5,10,15,20,30,40]
plt.figure()
plt.plot(w_set, error_ratio, 'r-', label = "test set error as a function of w")
